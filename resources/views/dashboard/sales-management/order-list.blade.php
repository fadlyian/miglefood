<x-app-layout>
    ...
    <div class="flex-auto ml-[32%] mt-[6%] max-w-[65%]">
        ...
        @if (count($ordersNotProcess) > 0)
            ...
            @endfor
        @else
            <div class="text-center bg-white text-[16px] p-6 shadow-sm hover:shadow-md rounded-lg w-full mb-6 transition ease-out">
        ...
        @else
            <div class="text-center bg-white text-[16px] p-6 shadow-sm hover:shadow-md rounded-lg w-full mb-6 transition ease-out">
                <strong>No orders have been processed at this time!</strong>
            </div>
        @endif
        ...
        @else
            <div class="text-center bg-white text-[16px] p-6 shadow-sm hover:shadow-md rounded-lg w-full mb-6 transition ease-out">
                <strong>No orders have been completed at this time!</strong>
            </div>
        @endif
    </div>
</x-app-layout>
